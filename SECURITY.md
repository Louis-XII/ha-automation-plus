...
seule la **dernière release publiée** (voir [Releases](https://github.com/la12lab/ha-automation-plus/releases))
...
👉 [Report a vulnerability](https://github.com/la12lab/ha-automation-plus/security/advisories/new)
...
[suivi d'issues normal](https://github.com/la12lab/ha-automation-plus/issues/new/choose)
à la place.
...
[GitHub Security Advisory](https://github.com/la12lab/ha-automation-plus/security/advisories)
